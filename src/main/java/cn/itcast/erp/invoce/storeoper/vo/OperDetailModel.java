package cn.itcast.erp.invoce.storeoper.vo;
...
public class OperDetailModel {
	...
	public static final Integer OPER_DETAIL_TYPE_OF_IN = 0;
	public static final Integer OPER_DETAIL_TYPE_OF_OUT = 1;
	
	public static final String OPER_DETAIL_TYPE_OF_IN_VIEW = "入库";
	public static final String OPER_DETAIL_TYPE_OF_OUT_VIEW = "出库";
	
	public static final Map<Integer, String> typeMap = new HashMap<Integer, String>();
	static {
		typeMap.put(OPER_DETAIL_TYPE_OF_IN, OPER_DETAIL_TYPE_OF_IN_VIEW);
		typeMap.put(OPER_DETAIL_TYPE_OF_OUT, OPER_DETAIL_TYPE_OF_OUT_VIEW);
	}
