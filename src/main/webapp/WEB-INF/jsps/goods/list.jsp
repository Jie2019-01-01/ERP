			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td>供应商:</td>
						<td>
							<s:select name="gqm.gtm.sm.uuid" list="supplierList" listKey="uuid" listValue="sname"
								headerKey="-1" headerValue="---请-选-择---" cssClass="kuan"/>
						</td>
						<td height="30">商&nbsp;品&nbsp;名</td>
						<td><s:textfield name="gqm.gname" size="14" /></td>
						<td>生产厂家</td>
						<td><s:textfield name="gqm.produce" size="14" /></td>
						<td>单&nbsp;&nbsp;&nbsp;&nbsp;位</td>
					...
					<tr>
						...
						<td>到</td>
						<td><s:textfield name="gqm.inMaxPrice" size="14" /></td>
						<td height="30">销售价格</td>
						<td><s:textfield name="gqm.outPrice" size="14" /></td>
						<td>到</td>
						<td><s:textfield name="gqm.outMaxPrice" size="14" /></td>
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<s:iterator value="goodsList">
						<tr align="center" bgcolor="#FFFFFF">
							<td width="13%" height="30">${gtm.gtname }</td>
							<td>${gname }</td>
							<td>${produce }</td>
							<td>${origin }</td>
