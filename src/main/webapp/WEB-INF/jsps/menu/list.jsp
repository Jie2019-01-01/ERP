			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="123">&nbsp;</td>
						<td width="62">菜单名称</td>
						<td width="142"><s:textfield name="mqm.mname" size="18"/></td>
						<td width="60">所属菜单</td>
						<td width="149">
							<s:select name="mqm.mm.uuid" cssClass="kuan" list="parentList" listKey="uuid" 
								listValue="mname" headerKey="-1" headerValue="---请-选-择---"/>
						</td>
						<td width="70"><a id="query"> <img src="images/can_b_01.gif" border="0" /> </a></td>
						<td width="70"><a href="menu_input"><img src="images/can_b_02.gif" border="0" /></a></td>
					</tr>
				</table>
			</div>
			<!--"square-o-top"end-->
						...
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td>
								...
								<span style="line-height:12px; text-align:center;"> 
									<s:a action="menu_input" class="xiu">
