...
<div class="content-right">
	...
	<div class="content-text">
			...
			<div class="square-order">
				...
				<br/>
				<s:form action="order_assignTaskMan.action" method="post">
					<s:hidden name="om.uuid"/>
					<table width="100%">
						<tr>
							<td width="50%" align="right">
								<s:select cssStyle="width:100px;font-size:20px" list="empList" 
									listKey="uuid" listValue="realName" name="completerUuid"/>
							</td>
