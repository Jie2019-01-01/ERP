			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>提货方式:</td>
						<td class="order_show_msg">${om.sm.patternView }</td>
						<td>订 单 号:</td>
				...
				<table width="100%">
					<tr>
						<td width="50%" align="center">
							<s:if test="om.status==@cn.itcast.erp.invoce.order.vo.OrderModel@ORDER_STATUS_OF_BUY_BUYING">
								<s:a action="order_endTask.action" cssStyle="color:#0f0;font-size:20px;
							...
							<s:else>
								<a href="javascript:history.back()" style="color:#f00;font-size:20px;
									padding-top:2px;font-weight:bold;text-decoration:none;width:82px;
									height:28px;display:block;background:url(images/btn_bg.jpg)">
									已结单
								</a>
