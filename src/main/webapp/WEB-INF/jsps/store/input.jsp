...
<div class="content-right">
	...
	<div class="content-text">
		<div class="square-order">
			<s:form action="store_saveOrUpdate.action" method="post">
  			...
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
				      	<s:textfield name="sm.sname" size="25"/>
				      </td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%" colspan="3">
				      	<s:select cssStyle="width:190px" list="empList" listKey="uuid" 
				      		listValue="realName" name="sm.em.uuid"/>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
